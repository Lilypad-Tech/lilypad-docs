...
This template includes an example of running a job using the [`cowsay`](../developer-resources/ai-model-marketplace/build-a-job-module/cowsay.md) module. The `cowsay` module is a simple program that generates an ASCII picture of a cow with a message.
