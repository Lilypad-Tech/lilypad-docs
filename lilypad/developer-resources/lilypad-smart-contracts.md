...
This template includes an example of running a job using the [`cowsay`](../run-a-model-on-lilypad/hello-cow-world.md) module. The `cowsay` module is a simple program that generates an ASCII picture of a cow with a message.
