...
{% hint style="info" %}
Open [LilypadEvents Contract in Remix](https://remix.ethereum.org/#url=https://github.com/bacalhau-project/lilypad-v0/blob/main/hardhat/contracts/LilypadEventsUpgradeable.sol)
{% endhint %}
...
{% hint style="info" %}
Open the [LilypadCaller Interface in Remix](https://remix.ethereum.org/#url=https://github.com/bacalhau-project/lilypad/blob/main/hardhat/contracts/LilypadCallerInterface.sol)
{% endhint %}
