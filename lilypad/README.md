...
* [Run](hardware-providers/run-a-node.md) a Lilypad node
...
4. **Multichain Support**: Lilypad plans to go multi-chain, which means it will support multiple blockchain networks. This will increase the scalability and interoperability of the network, allowing users to choose the blockchain that best suits their needs.
